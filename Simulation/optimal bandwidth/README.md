...
- `delta.hv.25/50/75`, `sparse.hv.25/50/75` and `dense.hv.100`: via hv-crossvalidation in a 5-fold framework
- `delta.optim.25/50/75`, `sparse.optim.25/50/75` and `dense.optim.100`: via true underlying difference and mean function <br>
